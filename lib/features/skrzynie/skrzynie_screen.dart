...
class CrateState {
  ...
  factory CrateState.fromFirestore(String id, Map<String, dynamic> d) => CrateState(
    ...
    // Stare dostawy (sprzed wdrożenia) bez pól pelne/puste: zostają jak dawniej —
    // w „pustych" (puste=remaining), 0 w „z produktem". Tylko NOWE karty (z polem
    // drew_pelne) trafiają do „z produktem".
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          SizedBox(
            ...
            child: OutlinedButton.icon(
              ...
              label: const Text('Wydaj wszystkie'),
              onPressed: () => setState(() {
                _drewCtrl.text  = _totalDrew.toString();
                _plastCtrl.text = _totalPlast.toString();
              }),
              style: OutlinedButton.styleFrom(
                foregroundColor: AppTheme.errorRed,
                side: const BorderSide(color: AppTheme.errorRed),
